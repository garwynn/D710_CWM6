...
int nandroid_backup(const char* backup_path)
{
    ...
    // Garwynn 4/11/2013 - Add Preload partition support.  1545
    if (0 != (ret = nandroid_backup_partition_extended(backup_path, "/preload", 0)))
        return ret;
    // End add.
...
int nandroid_restore(const char* backup_path, int restore_boot, int restore_system, int restore_data, int restore_cache, int restore_sdext, int restore_wimax, int restore_preload)
{
    ...
    // 4/11/2013 Garwynn 1546  Add restore of preload.
